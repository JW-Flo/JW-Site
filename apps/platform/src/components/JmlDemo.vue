<template>
  <div id="app">
    <div class="demo-banner">
      🚀 Interactive JML Lifecycle Demo - Paycom HRIS Integration with
      ...
      scenarios: [
        {
          ...
          description:
            "Jordan Miles joins as Security Engineer. Watch automated provisioning across Paycom, Okta and AWS.",
          progress: 0,
          employee: {
            employeeId: "EMP001",
            firstName: "Jordan",
          ...
          steps: [
            {
              ...
              description:
                "HR creates new employee record in Paycom with role requirements and triggers automated workflow",
            ...
            },
            {
              ...
              description:
                "API Manager calls Okta API to create user account with security group assignments",
            ...
            },
            {
              ...
              description:
                "AtlasIT creates AWS IAM role with security engineer permissions via direct API",
            ...
            },
            {
              ...
              description:
                "Automated provisioning of security tools and applications based on role requirements",
            ...
            },
            {
              ...
              description:
                "Verify all access grants meet SOC2, ISO27001 and company security policies",
        ...
        },
        {
          ...
          description:
            "Sarah Chen transfers from Engineering to DevOps team. Watch automated access adjustments.",
          progress: 0,
          employee: {
            employeeId: "EMP002",
            firstName: "Sarah",
          ...
          steps: [
            {
              ...
              description:
                "Paycom detects department transfer and triggers role change workflow",
            ...
            },
            {
              title: "Access Review",
              description:
                "AtlasIT analyzes current permissions and identifies changes needed for DevOps role",
            ...
            },
            {
              ...
              description:
                "Grant additional AWS and Kubernetes access required for DevOps role",
            ...
            },
            {
              ...
              description:
                "Remove engineering-specific permissions no longer needed",
            ...
            },
            {
              ...
              description:
                "Verify access changes and generate compliance audit trail",
        ...
        },
        {
          ...
          description:
            "Mike Rodriguez leaves the company. Watch secure offboarding and access revocation.",
          progress: 0,
          employee: {
            employeeId: "EMP003",
            firstName: "Mike",
          ...
          steps: [
            {
              ...
              description:
                "Paycom triggers immediate offboarding workflow upon termination",
            ...
            },
            {
              ...
              description:
                "Immediately disable Okta account and terminate all active sessions",
            ...
            },
            {
              ...
              description:
                "Remove all AWS permissions, access keys, and disable IAM user",
            ...
            },
            {
              ...
              description:
                "Revoke access from all SaaS applications and collaboration tools",
            ...
            },
            {
              ...
              description:
                "Generate compliance report and ensure secure data transfer to manager",
              systems: ["AtlasIT Data Governor", "Compliance Engine"],
              duration: "~10s",
              apiCall: "POST /api/compliance/offboard-audit",
              payload:
                "Offboarding compliance report and data transfer confirmation",
            },
          ],
        },
      ],
  ...
  mounted() {
    ...
    function sendScreenshotEvent(context = "jml-demo") {
      ...
      window.dispatchEvent(
        new CustomEvent("atlasit-analytics", {
          detail: {
            event: "screenshot",
            page: window.location.pathname,
            context,
  ...
  methods: {
    async selectScenario(id) {
      ...
      this.addGlobalLog(
        "info",
        "Demo System",
        `🎯 Selected ${this.currentScenario.title} scenario for ${this.currentEmployee.firstName} ${this.currentEmployee.lastName}`
      );
      this.addGlobalLog(
        "info",
        "Paycom HRIS",
        `📋 Employee record loaded: ${this.currentEmployee.employeeId}`
      );
    ...
    async executeStep(stepIndex) {
      ...
      if (step.title.includes("Paycom")) {
        this.addStepLog(
          stepIndex,
          `🏢 Paycom API: Processing employee data...`
        );
        await this.delay(500);
        this.addStepLog(
          stepIndex,
          `✅ Paycom: Employee record updated - ID: ${this.currentEmployee.employeeId}`
        );
        this.addStepLog(
          stepIndex,
          `📋 Event Type: ${this.getPaycomEventType(step.title)}`
        );
      }
      ...
      if (step.title.includes("Okta")) {
        ...
        this.addStepLog(
          stepIndex,
          `🔐 Okta Response: User account processed successfully`
        );
        this.addStepLog(
          stepIndex,
          `👤 Username: ${this.currentEmployee.firstName.toLowerCase()}.${this.currentEmployee.lastName.toLowerCase()}`
        );
        ...
        this.addStepLog(
          stepIndex,
          `🔑 Role: ${
            this.currentEmployee.department
          }${this.currentEmployee.title.replace(/\s+/g, "")}`
        );
        this.addStepLog(
          stepIndex,
          `🏷️ Tags: Department=${this.currentEmployee.department}`
        );
        ...
        this.addStepLog(
          stepIndex,
          `📱 Applications: ${apps.length} systems processed`
        );
        apps.forEach((app) => {
          this.addStepLog(stepIndex, `  ✓ ${app} access configured`);
        });
      } else if (
        step.title.includes("Compliance") ||
        step.title.includes("Audit")
      ) {
        await this.delay(300);
        this.addStepLog(
          stepIndex,
          `📋 Compliance: All operations meet policy requirements`
        );
        this.addStepLog(
          stepIndex,
          `🔍 Audit Trail: Generated and stored with ID: ${Date.now()}`
        );
      }
      await this.delay(500);
      ...
      this.addGlobalLog(
        "success",
        step.systems[step.systems.length - 1],
        `✅ Completed: ${step.title} (${step.duration})`
      );
    ...
    async completeWorkflow() {
      ...
      this.addGlobalLog(
        "success",
        "Demo System",
        `🎉 ${this.currentScenario.title} workflow completed for ${this.currentEmployee.firstName} ${this.currentEmployee.lastName}`
      );
      this.addGlobalLog(
        "info",
        "Paycom HRIS",
        `📊 Employee lifecycle event processed successfully`
      );
      await this.saveDemoState();
    },
    async runFullDemo() {
      ...
      this.addGlobalLog(
        "info",
        "Demo System",
        `🚀 Starting full ${this.currentScenario.title} demonstration`
      );
    ...
    resetDemo() {
      if (this.currentScenario) {
        ...
        this.addGlobalLog(
          "info",
          "Demo System",
          `🔄 Demo reset for ${this.currentScenario.title}`
        );
      }
    },
    toggleAutoAdvance() {
    ...
    getLogType(message) {
      ...
      if (message.includes("📡") || message.includes("Processing"))
        return "processing";
    ...
    getPaycomEventType(stepTitle) {
      ...
      if (stepTitle.includes("Update") || stepTitle.includes("Role"))
    ...
    updateProgress() {
      if (this.currentScenario) {
        this.currentScenario.progress = Math.round(
          (this.currentStepIndex / this.currentScenario.steps.length) * 100
        );
      }
    },
    async saveDemoState() {
