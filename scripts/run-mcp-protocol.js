...
const steps = [
  {
    ...
    context:
      "Gather comprehensive repo and code context for AtlasIT platform analysis",
  },
  {
    step: "wlan_market_scan",
    context: "Analyze current market trends in IT automation and management",
  },
  {
    step: "wlan_competitor_scan",
    context: "Identify key competitors and market positioning",
  },
  {
    step: "wlan_pricing_scan",
    context: "Research pricing models and market rates",
  },
  {
    step: "persona_research",
    context: "Understand target user profiles and pain points",
  },
  {
    step: "repo_feature_mapping",
    context: "Map implemented features against market needs",
  },
  {
    step: "synthesis_recommendations",
    context: "Generate comprehensive market validation report",
  },
];
...
async function runProtocol() {
  ...
  if (
    results.some((r) => r.success && r.step === "synthesis_recommendations")
  ) {
    console.log(
      "\n📄 Report generated: ./docs/MarketProductValidationReport.md"
    );
    console.log(
      "🔍 Check the report for detailed market analysis and recommendations"
    );
  }
